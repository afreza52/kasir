    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= base_url('stock/out') ?>" class="btn btn-warning btn-xs btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form method="post" action="<?= base_url('stock/process_out') ?>">
                        ...
                        <div class="form-group">
                            <label>Info *</label>
                            <input type="texy" name="info" id="info" placeholder="Rusak / hilang / kadeluwarsa /etc"
                        ...
                        <div class="form-group">
                            <button type="submit" name="out_add" class="btn btn-success btn-xs"><i
